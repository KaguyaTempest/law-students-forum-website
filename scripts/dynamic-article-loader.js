...
class DynamicArticleLoader {
        ...
        if (introLead) {
            html += `
                <div class="article-intro">
                    ...
                    ${introText ? `${introText}` : ''} // FIX: Removed escapeHtml and surrounding <p>
                </div>
            `;
        }
            ...
            sections.forEach(section => {
                html += `
                    <section>
                        ...
                        ${section.content} // FIX: Removed escapeHtml and surrounding <p>
                    </section>
                `;
            });
        }
        ...
        if (conclusionText) {
            html += `
                <div class="article-conclusion">
                    ...
                    ${conclusionText} // FIX: Removed escapeHtml. Assuming content is rich HTML (including <p> tags).
                </div>
            `;
        }
    ...
    // NOTE: This function is still useful for non-content fields (like titles, authors, topics) 
    // to prevent malicious HTML injection.
    escapeHtml(text) {
        if (!text) return '';
